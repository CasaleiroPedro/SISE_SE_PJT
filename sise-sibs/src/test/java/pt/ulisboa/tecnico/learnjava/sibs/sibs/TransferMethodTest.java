...
public class TransferMethodTest {
	...
	@Test
	public void successMockito() throws SibsException, AccountException, OperationException, BankException, ClientException {
		Services servicesMock = mock(Services.class);
		this.sibs = new Sibs(100,servicesMock);
...
//	public void successMockito1() throws SibsException, AccountException, OperationException, BankException, ClientException {
//		Services servicesMock = mock(Services.class);
//		this.sibs = new Sibs(100,servicesMock);
//		
//		String sourceIban = this.sourceBank.createAccount(Bank.AccountType.CHECKING, this.sourceClient, 1000, 0);
...
//		this.sibs.transfer(sourceIban, targetIban, 100);
//		
//		Mockito.when(method)thenReturn();
//		
//		assertEquals(1,this.sibs.getNumberOfOperations());
//	}
//	
