...
public class TransferOperationMethodTest {
		...
		public void setUp() throws BankException, ClientException, AccountException {
			...
			this.clientTarget = new Client(this.targetBank, "Manuel", "Alves", "123456788", "987654321", "Street", 33);
			this.client1Source  = new Client(this.sourceBank, "Mariana", "Fonseca", "123456781", "987654321", "Street", 33);
		...
		@Test
		public void successProccessDifferentBank() throws OperationException, AccountException, ClientException, BankException, SibsException {
		...
		@Test
		public void successProccessSameBank() throws OperationException, AccountException, ClientException, BankException, SibsException {
